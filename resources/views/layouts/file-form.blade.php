<form id="new-file-form" action="#" method="#" @submit.prevent="submitForm">
    <div class="upload-form">
        ...
        <div class="custom-file">
            ...
            <div class="to-long-overlay" onclick="">
                <i data-feather="x"></i>
            </div>
            <label class="custom-file-label" for="fileUploadLabel"><span v-if="!attachment.name"><i data-feather="upload"></i> &emsp; Neue Datei hinzufügen</span><span class="file-name" v-if="attachment.name" v-html="attachment.name"></span></label>
        </div>
